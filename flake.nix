  ...
  outputs = { self, ... }@inputs:
    ...
    in {
      ...
      packages = forAllSystems (system: {
        ...
        openfl_demo = demo system "openfl";
      });
      ...
      devShells = forAllSystems (system: {
        ...
        heaps_demo = (haxix system).heaps.mkShell (demo system "heaps");
        openfl_demo = (haxix system).openfl.mkShell (demo system "openfl");
      });
    };
}
