...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("bin/helloworld", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		#if !munit
		var app = new Main();
		app.meta.set("build", "31");
		app.meta.set("company", "none");
		app.meta.set("file", "bin/helloworld");
		app.meta.set("name", "helloworld");
		app.meta.set("packageName", "helloworld");
		app.meta.set("version", "0.1");
